...
class AlarmController:
    ...
    def run_alarm_interaction(self):
        ...
        # Skip Bluetooth confirmation in debug mode or when no serial connection is available.
        bluetooth_connection = getattr(self.bluetooth_connection, "bluetooth_io", None)
        has_bluetooth_link = getattr(bluetooth_connection, "connection", None) is not None
        if not self.debug_mode and has_bluetooth_link:
